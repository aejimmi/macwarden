...
"#;
    ...
    assert_eq!(svc.category, macwarden_core::ServiceCategory::Telemetry);
    assert_eq!(svc.safety, macwarden_core::SafetyLevel::Telemetry);
    assert_eq!(svc.description.as_deref(), Some("Apple analytics"));
    assert_eq!(svc.domain, macwarden_core::Domain::System);
}
...
"#,
    ...
    assert_eq!(svc.category, macwarden_core::ServiceCategory::ThirdParty);
    assert_eq!(svc.safety, macwarden_core::SafetyLevel::Optional);
...
"#,
    ...
    assert_eq!(
        svc.category,
        macwarden_core::ServiceCategory::Telemetry,
...
"#,
    ...
    assert_eq!(
        services[0].state,
        macwarden_core::ServiceState::Disabled,
...
fn test_infer_unknown_audio_service() {
    ...
    assert_eq!(cat, macwarden_core::ServiceCategory::Media);
    assert_eq!(safety, macwarden_core::SafetyLevel::Important);
    assert!(desc.is_some());
}
...
fn test_infer_unknown_bluetooth_service() {
    ...
    assert_eq!(cat, macwarden_core::ServiceCategory::Networking);
    assert_eq!(safety, macwarden_core::SafetyLevel::Optional);
    assert!(desc.is_some());
}
...
fn test_infer_unknown_notification_service() {
    ...
    assert_eq!(cat, macwarden_core::ServiceCategory::Unknown);
    assert_eq!(safety, macwarden_core::SafetyLevel::Optional);
    assert!(desc.is_some());
}
...
fn test_infer_unknown_security_service() {
    ...
    assert_eq!(cat, macwarden_core::ServiceCategory::Security);
    assert_eq!(safety, macwarden_core::SafetyLevel::Important);
    assert!(desc.is_some());
}
...
fn test_infer_unknown_filesystem_service() {
    ...
    assert_eq!(cat, macwarden_core::ServiceCategory::CoreOs);
    assert_eq!(safety, macwarden_core::SafetyLevel::Important);
    assert!(desc.is_some());
}
...
fn test_infer_unknown_accessibility_service() {
    ...
    assert_eq!(cat, macwarden_core::ServiceCategory::Accessibility);
    assert_eq!(safety, macwarden_core::SafetyLevel::Important);
    assert!(desc.is_some());
}
...
fn test_infer_unknown_third_party() {
    ...
    assert_eq!(cat, macwarden_core::ServiceCategory::ThirdParty);
    assert_eq!(safety, macwarden_core::SafetyLevel::Optional);
    assert!(desc.is_some());
}
