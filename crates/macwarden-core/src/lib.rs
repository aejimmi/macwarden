//! `macwarden-core` — pure-Rust policy engine, profile model, and decision logic.
//!
//! This crate has ZERO platform dependencies. It compiles and tests on any OS.
//! All macOS-specific behavior lives in other crates (`macwarden-launchd`,
//! `macwarden-es`).
//!
//! # Modules
//!
...
pub use group::{
    Safety, ServiceGroup, find_group, find_groups_for_service, parse_groups_toml,
